...
$query = "update restaurant set r_name = '{$r_name}', phone_number = '{$phone_number}', a_id = '{$a_id}', detailed_ad = '{$detailed_ad}', t_id = '{$t_id}' where r_id = {$r_id}";
...
else
{
    ...
    echo "<meta http-equiv='refresh' content='0;url=restaurant_confirm.php?r_id=$r_id'>";
}
?>